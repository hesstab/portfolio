    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.content}>
                ...
                <p>
                    My exposure to sequencing technology during my phD studies in the field of cancer genomics, and the enormous power of informatics in deciphering the hidden code within our most fundamental building blocks, DNA, made me curious in pursuing Computer science in more depth.
                </p>
                <p>
